...
public class Propagator {
	...
	public static void enterPropagator(Object[] argumentArray,
		...
		if (haveEnterHttp()) {
			//避免太多stringbuilder
			if (javaClassName.equals("java.lang.StringBuilder") && !((String) argumentArray[0]).contains("select"))
				return;
	...
	public static void leavePropagator(Object returnObject,
		...
		if (haveEnterHttp()) {
			//避免太多stringbuilder
			if (javaClassName.equals("java.lang.StringBuilder") && !returnObject.toString().contains("select"))
				return;
			CallChain callChain = new CallChain();
